...
#TYK_DASHBOARD_USERNAME="d.fontani@sintraconsulting.eu"
read  TYK_DASHBOARD_USERNAME

echo "insert password"
#TYK_DASHBOARD_PASSWORD="test123"
read TYK_DASHBOARD_PASSWORD
echo "user $TYK_DASHBOARD_USERNAME , password $TYK_DASHBOARD_PASSWORD"
